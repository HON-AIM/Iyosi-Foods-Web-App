      ...
      <section className="bg-white py-16 border-b border-surface-200">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-surface-100">
            ...
            <div>
              <div className="text-4xl md:text-5xl font-extrabold text-primary-600 mb-2">6</div>
              <div className="text-surface-600 font-medium uppercase tracking-wider text-sm">Product Categories</div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {productCategories.map((cat) => (
              <Link
                key={cat.title}
                href={cat.href}
                className="group relative rounded-2xl overflow-hidden shadow-lg bg-white border border-surface-200 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <p className="text-surface-600 leading-relaxed">All our products meet rigorous quality standards from production to delivery.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <svg className="w-8 h-8 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <p className="text-surface-600 leading-relaxed">Reliable nationwide delivery so your orders arrive fresh and on time.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <svg className="w-8 h-8 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <p className="text-surface-600 leading-relaxed">Competitive pricing on all products with special discounts for bulk orders.</p>
            </div>
          </div>
        </div>
      </section>
