...
export const metadata: Metadata = {
  title: "Our Leadership | Iyosi Foods LTD",
  description: "Meet the leadership team driving Iyosi Foods LTD's vision and mission in Nigeria's food industry.",
};
      ...
      <section className="bg-primary-50 py-12 md:py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-surface-600 mb-6 max-w-xl mx-auto">
            Explore career opportunities and grow with Iyosi Foods LTD
          </p>
