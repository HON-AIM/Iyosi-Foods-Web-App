...
export const metadata: Metadata = {
  title: "What We Do | Iyosi Foods LTD",
  description: "Discover Iyosi Foods LTD's operations in flour, rice, edible oils, pasta, and agro-allied products.",
};
    ...
    <div className="flex flex-col min-h-screen bg-surface-50">
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-surface-700 leading-relaxed mb-8">
            At Iyosi Foods LTD, we take our inputs and utilise our unique competitive advantages to produce and manufacture 
      ...
      <section className="bg-primary-900 text-white py-12 px-4 text-center">
        ...
        <p className="text-primary-100 mb-6 max-w-xl mx-auto">
          Become a partner and grow your business with Iyosi Foods LTD
        </p>
